import{e as F,h as i}from"./Matrix3PassUniform-285be0f9.js";import{e as c}from"./mat3f64-50f3b9f6.js";import{e as w}from"./mat4f64-abdda1bb.js";import{n as d}from"./vec3f32-01c06d8d.js";import{n as s}from"./vec3-015ca254.js";import{i as h,b as p,a,n as v}from"./ShaderBuilder-c7fc4a30.js";import{O as W}from"./VertexAttribute-15d1866a.js";import{a as n,e as M,b as m}from"./View.glsl-725bf3cf.js";import{e as P}from"./Texture2DPassUniform-1510cbb0.js";let R=class extends h{constructor(t,e){super(t,"mat3",p.Draw,(o,f,u)=>o.setUniformMatrix3fv(t,e(f,u)))}};function T(r){r.attributes.add(W.POSITION,"vec3"),r.vertex.code.add(a`vec3 positionModel() { return position; }`)}function V({code:r},t){t.doublePrecisionRequiresObfuscation?r.add(a`vec3 dpPlusFrc(vec3 a, vec3 b) {
