import{i as g,t as h}from"./ForwardLinearDepth.glsl-3606f02d.js";import{h as a}from"./Matrix3PassUniform-285be0f9.js";import{u as w}from"./Slice.glsl-e5fdd8d3.js";import{r as S}from"./Transform.glsl-e6366353.js";import{e as y}from"./VertexColor.glsl-e2eb2da5.js";import{o as $}from"./OutputDepth.glsl-ccbc6366.js";import{a as C}from"./OutputHighlight.glsl-569dde3f.js";import{n as D}from"./MultipassTerrainTest.glsl-029ffa3f.js";import{t as T}from"./AlphaCutoff-96178e0d.js";import{e as P,o as R}from"./TransparencyPassType-a1cb0602.js";import{v as b,c as j}from"./View.glsl-725bf3cf.js";import{e as V}from"./Float4PassUniform-52993952.js";import{o as p}from"./FloatPassUniform-8a52db3d.js";import{o as z,a as o}from"./ShaderBuilder-c7fc4a30.js";import{O as v}from"./VertexAttribute-15d1866a.js";var r;(function(e){e[e.Horizontal=0]="Horizontal",e[e.Vertical=1]="Vertical",e[e.Cross=2]="Cross",e[e.ForwardDiagonal=3]="ForwardDiagonal",e[e.BackwardDiagonal=4]="BackwardDiagonal",e[e.DiagonalCross=5]="DiagonalCross",e[e.COUNT=6]="COUNT"})(r||(r={}));const u=.70710678118,f=u,O=.08715574274;function A(e){const t=new z,n=e.hasMultipassTerrain&&(e.output===a.Color||e.output===a.Alpha);e.draped||t.extensions.add("GL_OES_standard_derivatives");const{vertex:i,fragment:l}=t;b(i,e),t.include(S,e),t.include(y,e),e.draped?i.uniforms.add(new p("worldToScreenRatio",(d,c)=>1/c.screenToPCSRatio)):t.attributes.add(v.BOUNDINGRECT,"mat3"),t.attributes.add(v.POSITION,"vec3"),t.attributes.add(v.UVMAPSPACE,"vec4"),t.varyings.add("vpos","vec3"),t.varyings.add("vuv","vec2"),n&&t.varyings.add("depth","float");const s=e.style===r.ForwardDiagonal||e.style===r.BackwardDiagonal||e.style===r.DiagonalCross;s&&i.code.add(o`
