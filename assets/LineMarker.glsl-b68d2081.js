import{p as d,b as h,i as u,s as g,t as v,o as S,e as y}from"./MarkerSizing.glsl-0f21463c.js";import{t as x,n as z}from"./ForwardLinearDepth.glsl-a0929473.js";import{h as i}from"./Matrix3PassUniform-0b3b1bba.js";import{u as P}from"./Slice.glsl-7975394d.js";import{o as w}from"./OutputDepth.glsl-f581dcdd.js";import{n as $}from"./MultipassTerrainTest.glsl-43f42334.js";import{t as b}from"./AlphaCutoff-96178e0d.js";import{e as L,o as D}from"./TransparencyPassType-a6b20292.js";import{a as N}from"./RgbaFloatEncoding.glsl-4a25e2a7.js";import{v as k,d as M,e as T}from"./View.glsl-03db830e.js";import{e as O,f as A}from"./Texture2DPassUniform-70e1e126.js";import{e as m}from"./Float4PassUniform-7f3c3ce8.js";import{o as f}from"./FloatPassUniform-e3702139.js";import{o as W,a as r}from"./ShaderBuilder-7bfc11d2.js";import{O as l}from"./VertexAttribute-15d1866a.js";function j(e){const o=new W,p=e.hasMultipassTerrain&&(e.output===i.Color||e.output===i.Alpha),n=e.space===d.World;e.hasTip&&n&&o.extensions.add("GL_OES_standard_derivatives"),o.include(h,e),o.include(u,e),e.output===i.Depth&&o.include(w,e);const{vertex:a,fragment:c}=o;return c.include(N),k(a,e),o.attributes.add(l.POSITION,"vec3"),o.attributes.add(l.UV0,"vec2"),o.attributes.add(l.AUXPOS1,"vec3"),o.varyings.add("vColor","vec4"),o.varyings.add("vpos","vec3"),o.varyings.add("vUV","vec2"),o.varyings.add("vSize","float"),x(o),p&&o.varyings.add("depth","float"),e.hasTip&&o.varyings.add("vLineWidth","float"),a.uniforms.add([new O("nearFar",(s,t)=>t.camera.nearFar),new m("viewport",(s,t)=>t.camera.fullViewport)]),a.code.add(r`vec4 projectAndScale(vec4 pos) {
