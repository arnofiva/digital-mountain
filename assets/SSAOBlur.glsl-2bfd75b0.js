import{x as d}from"./vec3-015ca254.js";import{o as i}from"./ScreenSpacePass.glsl-28a2b6e5.js";import{a as u}from"./ReadLinearDepth.glsl-9abddde9.js";import{f as p,o as s}from"./Texture2DDrawUniform-d1eaa0d6.js";import{f as m,e as b}from"./Texture2DPassUniform-1510cbb0.js";import{o as v}from"./FloatPassUniform-8a52db3d.js";import{o as w,a as t}from"./ShaderBuilder-c7fc4a30.js";const n=4;function _(){const a=new w,r=a.fragment;a.include(i);const f=(n+1)/2,c=1/(2*f*f);return r.include(u),r.uniforms.add([new m("depthMap",e=>e.depthTexture),new p("tex",e=>e.colorTexture),new s("blurSize",e=>e.blurSize),new v("projScale",(e,o)=>{const l=d(o.camera.eye,o.camera.center);return l>5e4?Math.max(0,e.projScale-(l-5e4)):e.projScale}),new b("nearFar",(e,o)=>o.camera.nearFar)]),r.code.add(t`
